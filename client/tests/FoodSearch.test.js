...
describe('FoodSearch', () => {
  ...
  afterEach(() => {
    // clear up any invocations from other specs
  ...
  describe('user populates search field', () => {
    ...
    describe('and API returns results', () => {
      ...
      describe('then user removes characters from the input', () => {
        const value = "bro";
      ...
      describe('then user clears the input', () => {
        beforeEach(() => {
          const input = wrapper.find('input').first();
      ...
      describe('then user clicks the remove icon', () => {
        beforeEach(() => {
